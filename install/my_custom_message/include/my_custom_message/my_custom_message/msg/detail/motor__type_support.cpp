...
{
  new (message_memory) my_custom_message::msg::Motor(_init);
}

void Motor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_custom_message::msg::Motor *>(message_memory);
  typed_message->~Motor();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Motor_message_member_array[3] = {
  {
    ...
    offsetof(my_custom_message::msg::Motor, left_w),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message::msg::Motor, right_w),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_custom_message::msg::Motor, linear_vel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::my_custom_message::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_message, msg, Motor)() {
  return &::my_custom_message::msg::rosidl_typesupport_introspection_cpp::Motor_message_type_support_handle;
}
